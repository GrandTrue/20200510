...
*/
  //oop
    ...
    $('#lbutton').click(()=>{
        let url = 'https://spreadsheets.google.com/feeds/list/1JmLm14TrvVqUlQVrZo0rLyxvLH-JdbRI_3-gny97ejA/1/public/values?alt=json';
        p5j.loaded=0;
        //console.log(url);
        p5j.httpGet(url, 'jsonp', false, function(response) {
    ...
    $('#ubutton').click(()=>{
        if(p5j.arrarea.length>0){
          ...
          let exeurl = 'https://script.google.com/macros/s/AKfycbzehicPrfM6M49f72vtf1q2pLcPxruVzBBlqMnfUN22WKEbrt_E/exec';          
          let editurl = 'https://docs.google.com/spreadsheets/d/1JmLm14TrvVqUlQVrZo0rLyxvLH-JdbRI_3-gny97ejA/edit#gid=0';
